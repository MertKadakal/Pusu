...
public class Elf extends Types {

    public Elf(String id, String posx, String posy) {
        this.id = id;
        this.max_move = Constants.elfMaxMove;
        this.hp = Constants.elfHP;
        this.def_hp = Constants.elfHP;
        ...
        if (check_exceptions(move)) {
            ...
            for (int i = 0; i < moves.length; i += 2) {
                ...
                if (check) { // True ise
                    ...
                    if (i == moves.length-2) {
                        //around_types.clear();
                        around_types.add(check_if_the_cell_is_filled(2, -2));
                        around_types.add(check_if_the_cell_is_filled(2, -1));
                        around_types.add(check_if_the_cell_is_filled(2, 0));
                        around_types.add(check_if_the_cell_is_filled(2, 1));
                        around_types.add(check_if_the_cell_is_filled(2, 2));
                        around_types.add(check_if_the_cell_is_filled(-2, -2));
                        around_types.add(check_if_the_cell_is_filled(-2, -1));
                        ...
                        around_types.add(check_if_the_cell_is_filled(-2, 1));
                        around_types.add(check_if_the_cell_is_filled(-2, 2));
                        around_types.add(check_if_the_cell_is_filled(-1, -2));
                        around_types.add(check_if_the_cell_is_filled(-1, 2));
                        around_types.add(check_if_the_cell_is_filled(0, -2));
                        around_types.add(check_if_the_cell_is_filled(0, 2));
                        around_types.add(check_if_the_cell_is_filled(1, -2));
                        around_types.add(check_if_the_cell_is_filled(1,2));
                    }
